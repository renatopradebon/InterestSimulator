unit eInterestSimulator.Model.Americano;
...
function TModelAmortizacaoAmericano.NumeroParcela(Value: Integer): iResultado;
begin
  Result := Self;
...
function TModelAmortizacaoAmericano.ValorAmortizacao(Value: Real): iResultado;
begin
  Result := Self;
...
function TModelAmortizacaoAmericano.ValorPagamento(Value: Real): iResultado;
begin
  Result := Self;
